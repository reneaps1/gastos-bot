...
async function main() {
  ...
  await prisma.quincena.createMany({
    data: [
      ...
      { codigo: 'Q28', fechaInicio: new Date('2026-05-29'), fechaFin: new Date('2026-06-14') },
      { codigo: 'Q29', fechaInicio: new Date('2026-06-15'), fechaFin: new Date('2026-06-29') },
      ...
      // ver lastBusinessDayOfMonth en src/quincenas.js.
      { codigo: 'Q33', fechaInicio: new Date('2026-08-14'), fechaFin: new Date('2026-08-31') },
      { codigo: 'Q34', fechaInicio: new Date('2026-09-01'), fechaFin: new Date('2026-09-14') },
      { codigo: 'Q35', fechaInicio: new Date('2026-09-15'), fechaFin: new Date('2026-09-30') },
      { codigo: 'Q36', fechaInicio: new Date('2026-10-01'), fechaFin: new Date('2026-10-14') },
      { codigo: 'Q37', fechaInicio: new Date('2026-10-15'), fechaFin: new Date('2026-10-30') },
      { codigo: 'Q38', fechaInicio: new Date('2026-10-31'), fechaFin: new Date('2026-11-12') },
      { codigo: 'Q39', fechaInicio: new Date('2026-11-13'), fechaFin: new Date('2026-11-30') },
      { codigo: 'Q40', fechaInicio: new Date('2026-12-01'), fechaFin: new Date('2026-12-14') },
      { codigo: 'Q41', fechaInicio: new Date('2026-12-15'), fechaFin: new Date('2026-12-31') },
      { codigo: 'Q42', fechaInicio: new Date('2027-01-01'), fechaFin: new Date('2027-01-14') },
    ],
    skipDuplicates: true,
  })
