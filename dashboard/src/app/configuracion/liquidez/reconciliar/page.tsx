...
function ConciliarContent() {
  ...
  async function guardarAjuste() {
    ...
    try {
      ...
      const fechaAjuste = hoy < data.quincena.fechaInicio
        ? data.quincena.fechaInicio.split('T')[0]
        : hoy > data.quincena.fechaFin.split('T')[0]
          ? data.quincena.fechaFin.split('T')[0]
          : hoy
